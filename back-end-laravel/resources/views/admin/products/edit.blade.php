...
<div class="container">
  <div class="d-flex">
    <h1 class="me-3 my-3">Modifica Prodotto</h1>
    <form class="my-4" action="{{ route('admin.products.destroy', $product->id) }}" method="POST"
    ...
    <div class="col-md-6">
      <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <div class="d-flex">
            <div id="uploaded-file"
              ...
              <span>{{$product?->image_original_name}}</span></div>
        ...
        <div class="mb-3">
          ...
          <button class="btn btn btn-outline-danger {{old('image', $product?->image) ? 'd-inline-block' : 'd-none'}}"
