    ...
    <table class="table table-striped table-bordered" id="products-table">
        <thead>
            <tr>
                ...
                <th scope="col">
                  <a class="text-black text-decoration-none hov-underline" href="{{route('admin.order-by', ['col' => 'price', 'dir' => $dir])}}">Prezzo
        ...
        <tbody>
            @foreach ($products as $product)
                <tr>
                    ...
                    <td>
                        <img class="thumb mt-3" src="{{isset($product->image) ? asset('storage/' . $product->image) : asset('img/no-image.jpg')}}" alt="Product Image" style="width: 150px; height: auto;">
                    </td>
                    <td>
                        <div class="d-flex">
