      ...
      <form id="restaurantForm" action="{{ route('admin.restaurants.update', $restaurant->id) }}" method="POST"
        ...
        <div class="mb-3">
          ...
          <div class="d-flex">
            ...
            <input name="logo" type="file"
              ...
              id="logo" placeholder="Carica immagine" value="{{ old('logo', $restaurant->logo) }}"
              onchange="showlogo(event); addFile()">
          </div>
          @error('logo')
        ...
        <div class="mb-3">
          <img class="thumb mt-3" id="thumb"
            src="{{ isset($restaurant->logo) ? asset('storage/' . $restaurant->logo) : asset('img/no-logo.jpg') }}"
