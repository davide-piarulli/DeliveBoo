...
return [
    [
        ...
        'type_ids' => [1, 14],
        'logo' => 'uploads/americano-2.png'
    ],
    [
        'name' => 'Trattoria da Luigi',
        'address' => 'Corso Vittorio Emanuele II, 20122 Milano MI',
        'type_ids' => [1, 8, 13, 14, 15],
        'logo' => 'uploads/barbecue-1.png'
    ],
    [
        'name' => 'Sakura Sushi',
    ...
    [
        ...
        'type_ids' => [4],
        'logo' => 'uploads/messicano-1.png'
    ],
    [
        'name' => 'Taj Mahal Indian Restaurant',
        'address' => 'Corso Buenos Aires, 20124 Milano MI',
        'type_ids' => [5, 16],
        'logo' => 'uploads/indiano-1.png'
    ],
    [
        'name' => 'Olympus Taverna',
    ...
    [
        ...
        'type_ids' => [13, 14],
        'logo' => 'uploads/steakhouse-2.png'
    ],
    [
        'name' => 'Mamma Mia Pizzeria',
        'address' => 'Viale Papiniano, 20123 Milano MI',
        'type_ids' => [1],
        'logo' => 'uploads/pizza-2.png'
    ],
    [
        'name' => 'Turkish Delight',
        'address' => 'Via Fiori Chiari, 20121 Milano MI',
        'type_ids' => [11],
        'logo' => 'uploads/greco-2.png'
    ],
    [
        'name' => 'Lebanese Bistro',
        'address' => 'Via Orefici, 20123 Milano MI',
        'type_ids' => [12],
        'logo' => 'uploads/libanese-1.png'
    ],
    [
        'name' => 'Fast & Fresh',
        'address' => 'Corso Garibaldi, 20121 Milano MI',
        'type_ids' => [15],
        'logo' => 'uploads/fast-food-1.png'
    ],
    [
        'name' => 'Seafood Sensation',
        'address' => 'Via Montenapoleone, 20121 Milano MI',
        'type_ids' => [16],
        'logo' => 'uploads/restaurant-4.png'
    ],
    [
        'name' => 'Steakhouse Deluxe',
        'address' => 'Via Dante, 20121 Milano MI',
        'type_ids' => [13],
        'logo' => 'uploads/restaurant-3.png'
    ],
    [
        'name' => 'Burger Joint',
        'address' => 'Corso Como, 20154 Milano MI',
        'type_ids' => [8, 15],
        'logo' => 'uploads/fast-food-2.png'
    ],
    [
